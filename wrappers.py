...
class CityWeather:
    def __init__(self, city, region, current, feels_like, condition):
        self.city = city
        self.region = region
...
class WeatherAPI:
    ...
    # Private method that will set up the request url, make the get request,k and return the JSON response body or None if issue
    # The __ before the function name is a naming convention for making a private method
    # A Private method is only callable from within the class
    ...
    # Public method that will take in a city name an return a city object
    def get_current_weather(self, city):
        ...
        if weather_data:
            ...
            # Creat a CityWeather instance with above info
    ...
    def get_astronomy(self, city):
        ...
        if astro_data:
            ...
            # Creat an instance of CityAstronomy with the above data
